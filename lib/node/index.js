...
class Node{
    constructor(blockchains) {
        ...
        this.peers = [];
        this.chains = []; // Array of blockchain objects
        this.init();
    }

    init(){
        // Populate peer array from what is in db
        this.peers = await peerDb.get('peers');

        // Pull all blockchains from the db and put into chains array
        this.chains = [];

        this.hookBlockchains();
    ...
    initConnection(peer) {
        // Get the peer's latest block and pending responses
