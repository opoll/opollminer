...
var cli = require('../../minerclient/CLI');
// cpp POW controller
controller.POWController = require("../../minerclient/POWControljs")(databases, controller);
...
controller.initialize = async function() {
  ...
  console.log( "working " + shardsToWork.length + " shards" );
