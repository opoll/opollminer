...
/*
  BIG TODO:
  Convert this module to use /shard/meta objects instead of just pollHashes
*/
...
lib.fetchActiveShards = function() {
  return new Promise( async function( resolve ) {
    ...
    var resp = await axios.get( NetworkModule.API_URL + "/shards.json" );
...
lib.recordActiveShards = function( shardMetadataArr ) {
  return new Promise( async function( resolve ) {
    ...
    shardMetadataArr.forEach( function( shardMeta ) {
      // If this shard was not recorded, add it
