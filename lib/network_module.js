...
lib.listen = function( nodeType, logicController ) {
  ...
  // Non-Token Restricted Endpoint for checking if a token is valid
  ...
  */
  ...
  if( nodeType == "mainchain" ) {
    ...
    app.route('/main/:shardID/shardcomplete').get(logicController.p2p.receiveShardChain); 
  ...
  // Start Listening
  global.listener = app.listen(minerport, function () {
