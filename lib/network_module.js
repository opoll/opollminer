...
lib.listen = function( nodeType, logicController ) {
  ...
  */
  if( nodeType == "shard" ) {
    ...
    app.route('/admin/chains/shards').get(adminController.getShardsInfo);
    app.route('/admin/chains/shards/:shardId/event').get(adminController.toggleShardState);
    app.route('/admin/chains/shards/:shardId').delete(adminController.deleteShard);
  }
  ...
  */
  if( nodeType == "mainchain" ) {
    ...
    app.route('/admin/chains/mainchain').get(adminController.getMainchainInfo);
    app.route('/admin/chains/mainchain/event').get(adminController.toggleMainchainState);
    app.route('/admin/chains/mainchain').delete(adminController.deleteMainchain);
