...
lib.generateWalletAddress = function(publicKey, versionByte = '00'){
    ...
    console.log("dhashVersionedPubKeyHash2: ", dhashVersionedPubKeyHash2);
    ...
    console.log("binaryAddressAsBuffer", Buffer.from(binaryAddress, 'hex'))
