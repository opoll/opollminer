...
POWControl.generateLatestBlock = async function (shardID) {
   ...
   // console.log(activeShards);
    ...
    var previousBlock = shard.blocks[latestBlockNumber];
    ...
    await ShardLogicController.LedgerManager.CalculateLedgerForChain(shardID);
   
    var latestLedger = ShardLogicController.LedgerManager.getLedgerFromBlock(shardID, latestBlockNumber);
