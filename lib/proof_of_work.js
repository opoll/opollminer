...
var POWControl = {};
POWControl.maxHashString = "000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF";
...
POWControl.OnHashMined = async function( shardID, nonce ) {
    ...
    var block = POWControl.CurrentShards[shardID];
    block.nonce = nonce;
...
POWControl.CreateMiner = function () {
    ...
    console.log(`Spawning child process at '${process.env.POW_SLAVE_PROC}'`);
